...
def compute_attn_weighted_similarity_loss(
    image_embeddings_dict, 
    evimg_embeddings_dict, 
    block_feature_indexes, 
    block_loss_weight,
    token_weights_dict,
    images,
    evimgs
...
class TotalLoss(torch.nn.Module):
    ...
    def forward(
        ...
        similarity_loss,source_similarity_loss_list,similarity_loss_list = compute_attn_weighted_similarity_loss(
            image_embeddings_dict, 
            evimg_embeddings_dict, 
            self.block_feature_indexes, 
            self.block_loss_weight, 
            token_weights_dict,
            images,
            evimgs
        )
