...
def _build_mix_rgbe_encoder_b(checkpoint_path, clip2sam=False):
        ...
        # checkpoint_path ="/data/sjlee/EventSAM/pretrained/sam_vit_b_01ec64.pth"
        if clip2sam:
          ...
          for key,value in checkpoint.items():
            if "image_encoder" in key:
                new_key = key[7:]
                rgbe_encoder_dict[new_key] = value
                if "pos_embed" in new_key:
                    rgbe_encoder_dict[new_key] = value[:,:32,:32,:]
